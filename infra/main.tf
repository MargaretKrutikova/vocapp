...
# resource "azurerm_application_insights" "propscraperappinsights" {
#   name                = "propscraper-appinsights"
#   location            = azurerm_resource_group.vocappgroup.location
#   resource_group_name = azurerm_resource_group.vocappgroup.name
#   application_type    = "web"
# }

# resource "azurerm_application_insights_web_test" "propscraperwebtest" {
#   name                    = "propscraper-appinsights-webtest"
#   location                = azurerm_resource_group.vocappgroup.location
#   resource_group_name     = azurerm_resource_group.vocappgroup.name
#   application_insights_id = azurerm_application_insights.propscraperappinsights.id
#   kind                    = "ping"
#   frequency               = 300
#   timeout                 = 120
#   enabled                 = true
